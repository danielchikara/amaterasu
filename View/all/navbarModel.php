        ...
        <div class="col-xs-8">
            <div class="contenedor-tabla pull-right">
                <div class="contenedor-tr">
                    ...
                    <a href="?c=Categoria&a=Index" class="table-cell-td">Categorias</a>
                    <a href="?c=producto&a=Index" class="table-cell-td">Producto</a>
                    <a href="index.php?c=cliente&a=admin" class="table-cell-td">Regresar</a>
                    <?php
                    
                    if(isset($_SESSION['NOMBRE'])){
                        
                        echo '<a href="?c=security&m=logOut" class="table-cell-td">Cerrar sesion</a>';
